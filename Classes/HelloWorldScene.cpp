...
bool HelloWorld::init()
{
    ...
    img->setPositionType(Widget::PositionType::PERCENT);
    img->setPositionPercent(Vec2(0.5, 0.5));
    img->loadTexture("HelloWorld.png", TextureResType::LOCAL);
    img->setScale(0.5);
    
    //wrong behavior code1:
//    auto img = Sprite::create("HelloWorld.png");
//    img->setScale(0.5);
    
    //wrong behavior code2:
//    auto img = ImageView::create();
//    img->loadTexture("HelloWorld.png", TextureResType::LOCAL);
//    img->setScale(0.5);
